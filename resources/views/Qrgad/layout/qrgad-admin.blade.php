...
<head>
  ...
  <body data-background-color="bg3">
                  ...
                  <div class="dropdown-user-scroll scrollbar-outer">
                    <li>
                      <div class="user-box">
                        ...
                        <div class="u-text">
                          <h4 class="text-uppercase">{{ $nama2 =  explode(" ", auth()->user()->nama)[0] }}</h4>
          ...
          <div class="sidebar-content">
              ...
              <div class="info">
                <a data-toggle="collapse" href="#collapseExample" aria-expanded="true">
                  <span class="text-uppercase">
                    {{ $nama2 =  explode(" ", auth()->user()->nama)[0] }}
            ...
            <ul class="nav nav-primary">
              ...
              @if (Auth::user()->level == "LV00000001" || Auth::user()->level == "LV00000002" || Auth::user()->level == "LV00000003" || Auth::user()->level == "LV00000004")
                        ...
                        @if (Auth::user()->level == "LV00000001" || Auth::user()->level == "LV00000002" )
                          <li class="{{ Request::is('keluhan-dashboard*')? 'active' : '' }}">
                            <a href="{{ url('/keluhan-dashboard') }}">
                              <span class="sub-item ">Dashboard Maintance</span>
                            </a>
                          </li>
                        @endif
                ...
                {{-- MODUL INVENTORY --}}
                @if (Auth::user()->level == "LV00000001" || Auth::user()->level == "LV00000002")
                  <li class="nav-item {{ Request::is('inventory*') || Request::is('kategori-konsumable') || Request::is('sub-kategori-konsumable*') || Request::is('konsumable/create*') || Request::is('report-inventory') ? 'active' : '' }}">
                    ...
                    <div id="inventory" class="collapse {{ Request::is('inventory*') || Request::is('kategori-konsumable*') || Request::is('konsumable/create*') || Request::is('sub-kategori-konsumable*') || Request::is('inventory-report') ? 'show' : ''  }}">

                    {{-- <div id="inventory" class="collapse {{ Request::is('inventory*') || Request::is('kategori-konsumable*') || Request::is('konsumable*') || Request::is('sub-kategori-konsumable*')? 'show' : ''  }}"> --}}
                        ...
                        @if (Auth::user()->level == "LV00000001" || Auth::user()->level == "LV00000002" )
                          <li class="{{ Request::is('inventory*')? 'active' : '' }}">
                            <a href="{{ url('/inventory') }}">
                              <span class="sub-item ">Tabel Inventory</span>
                            </a>
                          </li>
                        @endif
                      ...
                      @if (Auth::user()->level == "LV00000001" || Auth::user()->level == "LV00000002")
                      <li class="{{ Request::is('report-inventory*')? 'active' : '' }}">
                        ...
                        @if (Auth::user()->level == "LV00000001"|| Auth::user()->level == "LV00000002")
                          <li class="{{ Request::is('trip-schedule*')? 'active' : '' }}">
                            <a href="{{ url('/trip-schedule') }}">
                              <span class="sub-item ">Jadwal Trip</span>
                            </a>
                          </li>
                        @endif
    ...
    <!-- Chosen -->
    <script src="{{ URL::asset('assets/Atlantis-Lite-master/plugins/chosen/chosen.jquery.js') }}"></script>
