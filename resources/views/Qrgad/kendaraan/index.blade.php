                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center">
                                        <div class="form-button-action">
                                            ...
                                            <a href="" type="button" data-value="{{ $k->id }}" data-toggle="modal" data-target="#modalDelete" rel="tooltip" title="Delete" onclick="$('#modalDelete #formDelete').attr('action', '/kendaraan/{{ $k->id }}')" class="delete-modal btn btn-lg btn-link btn-danger">
