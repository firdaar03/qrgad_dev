...
<div class="modal-body">
    <div class="card shadow">
		<div class="card-header">
			<h4 class="fw-bold">Yakin approve request kendaraan ini ?</h4>
		</div>
		<div class="card-body">
...
<div class="modal-footer">
    <div class="inline">
        <button class="btn btn-success float-right" onclick="approve('{{ $trip_request->id_trip_request }}')">Approve</button>
