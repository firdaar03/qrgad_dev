...
function showAlert(state, title, message){ //type (success/error)
	var content = {};
	content.title = title;
	...
	switch(state){
		case 'success' : 
			content.icon = 'far fa-check-circle';
			break;
		case 'warning' : 
			content.icon = 'fas fa-exclamation-circle';
			break;
		case 'danger' : 
			content.icon = 'far fa-times-circle';
			break;
	}
...
function getAlert(state, action, menu){
	var status = '';
	var title = '';
	var message = '';
	...
	switch(action){
		case 'add' : 
			title = 'Tambah Data';
			message = status + ' menambahkan data ' + menu;
			break;
		case 'edit' : 
			title = 'Edit Data';
			message = status + ' mengubah data ' + menu;
			break;
		case 'delete' : 
			title = 'Hapus Data';
			message = status + ' menghapus data ' + menu;
			break;
		case 'tanggalgagal' : 
			title = 'Filter Tanggal';
			message = status + ' tanggal awal tidak boleh lebih dari tanggal akhir ' + menu;
		break;
		case 'tanggalsuccess' : 
			title = 'Filter Tanggal';
...
function mandatory(){
	if(document.querySelector(".mandatory") != null){

		const parentObject = document.getElementsByClassName('mandatory');
